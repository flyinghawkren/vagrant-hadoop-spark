...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "node1" do |node1|
    ...
    node1.vm.provision "shell", path: "provisioning/setup-hosts.sh", privileged: false,
    ...
    node1.vm.provision "shell", path: "provisioning/setup-node.sh", privileged: false
  ...
  config.vm.define "node2" do |node2|
    ...
    node2.vm.provision "shell", path: "provisioning/setup-hosts.sh", privileged: false,
      :args => "#{vm_cfg['master']['ipv4']} #{vm_cfg['master']['hostname']} #{vm_cfg['node1']['ipv4']} #{vm_cfg['node1']['hostname']} #{vm_cfg['node2']['ipv4']} #{vm_cfg['node2']['hostname']}"
    node2.vm.provision "shell", path: "provisioning/setup-node.sh", privileged: false
  ...
  config.vm.define "master" do |master|
    ...
    master.vm.provision "shell", path: "provisioning/setup-hosts.sh", privileged: false,
      :args => "#{vm_cfg['master']['ipv4']} #{vm_cfg['master']['hostname']} #{vm_cfg['node1']['ipv4']} #{vm_cfg['node1']['hostname']} #{vm_cfg['node2']['ipv4']} #{vm_cfg['node2']['hostname']}"
